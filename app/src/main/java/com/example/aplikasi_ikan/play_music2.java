...
public class play_music2 extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent suara1 = new Intent(play_music2.this, MainActivity.class);
    ...
    private void playAudio(){
        ...
        mediaPlayer = MediaPlayer.create(this, R.raw.croaker);
