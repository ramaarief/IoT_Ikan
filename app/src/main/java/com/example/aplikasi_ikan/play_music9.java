...
public class play_music9 extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_play_music9);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent suara1 = new Intent(play_music9.this, MainActivity.class);
    ...
    private void playAudio(){
        ...
        mediaPlayer = MediaPlayer.create(this, R.raw.snapper);
