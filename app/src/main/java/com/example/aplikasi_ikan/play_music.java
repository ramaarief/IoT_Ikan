...
public class play_music extends AppCompatActivity implements View.OnClickListener{
    ...
    private ToggleButton Play2;
    private ToggleButton Stop2;
...
//    private String[] Item = { "Pilih Interval","0", "5", "10", "15", "20", "25", "30", "35", "40", "45", "50", "55", "60" };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent suara1 = new Intent(play_music.this, MainActivity.class);
    ...
    private void playAudio(){
        ...
        mediaPlayer = MediaPlayer.create(this, R.raw.calling_female);
        ...
        if (List.getSelectedItem().toString().equals("Pilih Interval")) {
            ...
            Play2.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
    ...
    private void stopAudio(){
        ...
        Stop2.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked)
            {
                if (isChecked){
                    //Menjalankan Audio / Musik
